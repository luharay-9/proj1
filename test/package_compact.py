...
ROOT='/Users/harrylu/Downloads/proj1/test/'
path=ROOT+'Shinguard_CoreOnly_Compact.FCStd'
with zipfile.ZipFile(ROOT+'Shinguard_Redesigned_CoreOnly.FCStd') as src,zipfile.ZipFile(path) as dst:
 ...
 for i,n in enumerate(names):
  ...
  if vis is not None:
   ...
   if n in ['BackCarrier','ImpactShell','Part__Feature355','Adafruit_BNO085_STEMMA_QT_v2','_400mAh_Battery_v2','PCB_Component','Adafruit_ESP32_Feather_V2_v2']:vis.set('value','true')
  tr=props.find("Property[@name='Transparency']/Integer")
  if tr is not None:tr.set('value','65' if n=='ImpactShell' else '0')
  if n in ['BackCarrier','ImpactShell']:
